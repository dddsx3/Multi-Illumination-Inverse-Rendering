> **[SUPERSEDED 20260907 → TCI]** venue 已冻结 IEEE TCI；本四支柱骨架被
> 《Calibration_Confidence_Continuum_TCI_实验设计书_v1.0》（docs/ 下）取代。
> 支柱①②④结论仍可作历史证据链引用；支柱③两行 ⏸ 标注不再更新。
> 新章节映射 = 宪法 §9；卡片排程 = `docs/主控计划书_20260907_*.md` §4。

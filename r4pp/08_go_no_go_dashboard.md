...
| Gate | 指标 | 结果 | 证据 |
|---|---|---|---|
| Instrument | M1 log-pdet 5/5 stability PASS | **PASS** | MA=0.9991149623068079 MB=0.9926632664346688 MC=0.9961007929587933 MF=0.9982353258898602 |
| Signal | low-N signal/noise | **PASS** | R_signal: N=2 31, N=3 43, N=5 30, N=8 23 |
| Direction | info→error β<0 | **PASS** | β med=-0.348, 负占比=0.81 |
| Interaction | G↑ ⇒ |β_G|↑ | **FAIL** | A:ρ=+0.29(n=10); B:ρ=-0.23(n=6) |
| Saturation | N=8 noise-floor | **PASS** | N=8 R_signal=22.6 vs N=3 43.0 |
